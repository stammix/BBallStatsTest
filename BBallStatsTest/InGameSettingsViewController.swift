...
//        }
 ...
 //       homeColorPale = true
  ...
  //      players.startingfive = starters as NSObject
        ...
        team1.fieldplayers = [Int32(T1P1NrTextField.text!), Int32(T1P2NrTextField.text!), Int32(T1P3NrTextField.text!), Int32(T1P4NrTextField.text!), Int32(T1P5NrTextField.text!)] as? [Int32]
